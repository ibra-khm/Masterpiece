    ...
    return (
        <>
            <div className="max-w-screen flex flex-wrap h-[30rem]  bg-center bg-no-repeat bg-cover bg-[url('./images/hero.jpg')]">
                <div className="container text-white z-10 flex flex-col flex-wrap content-center justify-center p-4 py-20 mx-auto md:p-10">
                    ...
                    <div className='content-center justify-center text-gray-500 flex'>
